...
import me.yoyfook.app.myutils.ui.ToastUtils;
    ...
    private final BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (newState == BluetoothGatt.STATE_CONNECTED) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ToastUtils.show(mCtx, "新设备连接：" + device.getAddress());
                        }
                    });
                ...
                // 设备断开
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ToastUtils.show(mCtx, "设备断开：" + device.getAddress());
                        }
                    });
                ...
                // 其他操作
                    ...
                    Log.v(TAG, "GATT operation sucess: " + newState);
                }
            }
        ...
        public void onNotificationSent(BluetoothDevice device, final int status) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ToastUtils.show(mCtx, "发送通知：" + status);
                }
            });
